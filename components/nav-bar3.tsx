...
const NavBar3: NextPage<NavBar3Type> = ({ leafNodeHeight, propBorderTop }) => {
  ...
  return (
    <header
      className="self-stretch h-16 flex flex-col items-start justify-start pt-3 px-0 pb-0 box-border gap-[12px] max-w-full mq1050:h-auto"
      style={navBar1Style}
    >
      ...
      <div
        className="self-stretch h-0.5 relative box-border border-t-[1.5px] border-solid border-shades-dark-1"
        style={divider2Style}
      />
    </header>
  );
