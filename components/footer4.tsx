...
const Footer4: NextPage<Footer4Type> = ({ luminaScreen, propBorderTop }) => {
  ...
  return (
    <footer className="self-stretch overflow-hidden flex flex-row items-end justify-center py-10 px-5 box-border relative gap-[16px] min-h-[274px] max-w-full text-left text-3xs text-shades-carbon font-overline-footer lg:flex-wrap lg:justify-center">
      <div
        className="h-px w-[1441px] relative box-border hidden max-w-full z-[0] border-t-[1px] border-solid border-shades-dark-1"
        style={divider1Style}
      />
      <img
