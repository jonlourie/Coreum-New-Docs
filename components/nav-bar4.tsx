...
const NavBar4: NextPage<NavBar4Type> = ({ leafNodeHeight, propBorderTop }) => {
  ...
  return (
    <header
      className="self-stretch flex flex-col items-start justify-start pt-3 px-0 pb-0 box-border gap-[12px] max-w-full"
      style={navBarStyle}
    >
      <div className="self-stretch flex flex-row items-start justify-start py-0 px-6 box-border max-w-full">
        <div className="flex-1 flex flex-row items-start justify-between max-w-full gap-[20px] mq1050:flex-wrap">
          <div className="w-[133.3px] flex flex-col items-start justify-start pt-[10.800000000000182px] px-0 pb-0 box-border">
            <div className="self-stretch flex flex-row items-end justify-start gap-[5.299999999999272px]">
              <img
      ...
      <div
        className="self-stretch h-px relative box-border border-t-[1px] border-solid border-shades-dark-1"
        style={dividerStyle}
      />
    </header>
  );
