...
const NavBar: NextPage = () => {
  return (
    <header className="self-stretch flex flex-row items-start justify-between py-3 px-6 box-border max-w-full gap-[20px]">
      <div className="w-[133.3px] flex flex-col items-start justify-start pt-[10.800000000000182px] px-0 pb-0 box-border">
        <div className="self-stretch flex flex-row items-end justify-start gap-[5.300000000000182px]">
          <img
      ...
      <div className="w-[679px] flex flex-row items-start justify-start gap-[12px] max-w-full">
        <div className="flex-1 flex flex-row items-start justify-start gap-[12px] max-w-full">
          ...
          <div className="flex-1 rounded-lg bg-shades-dark-1 overflow-hidden flex flex-row items-start justify-start py-2.5 px-4 gap-[10px]">
            <img
