...
import AIModule from "./a-i-module";

const Footer: NextPage = () => {
  return (
    <footer className="self-stretch flex flex-row items-end justify-center py-10 px-5 box-border relative gap-[16px] min-h-[274px] max-w-full text-left text-3xs text-shades-carbon font-overline-footer lg:flex-wrap">
      <img
