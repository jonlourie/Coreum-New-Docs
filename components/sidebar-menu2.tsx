...
const SidebarMenu2: NextPage = () => {
  return (
    <div className="w-[276px] flex flex-col items-end justify-start py-6 px-4 box-border text-left text-sm text-shades-light font-regular-label mq1050:hidden">
